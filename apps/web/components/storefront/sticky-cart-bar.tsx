...
export function StickyCartBar() {
  ...
  return (
    <div className="glass fixed inset-x-0 bottom-0 z-40 border-t border-ink-200 shadow-floatLg animate-fade-in">
      <Link
        href="/cart"
        className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 transition-colors duration-150 ease-smooth hover:bg-ink-50/50 sm:px-6 lg:px-8"
      >
