...
import { slugify, type Category, type CreateProductInput, type Product, type ProductStatus, type SectionOverrideInput } from "@clothing-brand/shared";
...
export function AiGenerateButton({ onGenerate, disabled }: { onGenerate: () => Promise<string>; disabled?: boolean }) {
